...
<div class="row align-items-center">
  <div class="col-12 col-md-6">
    <h1 class="h2">Discover, trust, and reuse research software metadata</h1>
    <p>
    ...
    <p class="mt-3">
      <a class="btn btn-primary me-2" href="/sources">View metadata sources</a>
      <a class="btn btn-outline-primary" href="/docs">Read the documentation</a>
    </p>
  </div>
  <div class="col-12 col-md-6">
